	...
	switch (qa_user_post_permit_error('permit_post_a', $question, QA_LIMIT_ANSWERS)) {
		...
		case false:
			...
			/*$form=array(
                ...
                //'tags' => 'method="post" action="http://localhost/viga/index.php"',
...
//                        'style' => 'tall',
//                        'type' => 'static',
//                        'label' => qa_lang_html('question/red'),
//                        'tags' => 'onclick="http://localhost/viga/index.php"',
//
//                        //'note' => ''.create_output(),
//                    ),
					'answer' => array(
...
//	return $x;
//
//    $x='<a href="http://localhost/viga/index.php">
